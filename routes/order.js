...
const {getAll,getDetail,countOrder, countOrderByState, addNew, addOrderDetail, getWaitingOrder, accept, getDeliver, getMyOrder, receiveOrder, getOrderById} = require('../app/models/Order')
